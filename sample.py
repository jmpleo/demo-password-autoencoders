...
def main():
    ...
    program_info = {
        ...
        'supported_methods': ['pae'], #, 'pcfg', 'passgan'],
        ...
        'pae' : {
            ...
            'wordlist_first': 'wordlists/top1k',
    ...
    if not all(os.path.exists(path) for path in requred_dirs):
        ...
        for path in requred_dirs:
            os.makedirs(path, exist_ok=True)


    wordlist = None

    if program_info['pae']['wordlist_first'] != 'skip':
        wordlist = os.path.join(
            root_dir,
            program_info['pae']['wordlist_first']
        )
    ...
    if args.method == 'pae':
        ...
        save_dir = os.path.join(root_dir, program_info['pae']['save_dir'])
